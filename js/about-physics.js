...
window.addEventListener('load', () => {
    ...
    const wordsData = [
        ...
        { text: "サッカー少年", title: "サッカー少年", detail: "学生時代はサッカー部で、とにかくボールを蹴るのが日常でした。自分でプレイするのはもちろんですが、国内外の試合を観戦するのも趣味の一つです。戦術の面白さや、劇的なゴールシーンを見たときのあのワクワク感は、何歳になっても色褪せない最高のエンターテインメントだと思っています。" },
